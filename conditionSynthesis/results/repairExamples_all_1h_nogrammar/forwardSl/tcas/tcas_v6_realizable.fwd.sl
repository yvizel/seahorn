...
(let ((a!6 (and (mainventry vg_0 vfind_condition_0 mainv%sm45_0 vnd_0)
                ...
                (= mainv%sm6_0 (store mainv%sm50_0 mainv%Other_Tracked_Alt_0 0))
                (> mainv%Own_Tracked_Alt_0 0)
                (= mainv%sm7_0 (store mainv%sm52_0 mainv%Own_Tracked_Alt_0 0))
                (> mainv%High_Confidence_0 0)
                (= mainv%sm8_0 (store mainv%sm55_0 mainv%High_Confidence_0 0))
                ...
                (= mainv%sm11_0
                   (store mainv%sm57_0 mainv%Two_of_Three_Reports_Valid_0 0))
                (> mainv%Other_RAC_0 0)
