...
(let ((a!6 (and (mainventry vg_0 vfind_condition_0 mainv%sm50_0 vnd_0)
                ...
                (= mainv%sm2_0 (store mainv%sm51_0 mainv%Up_Separation_0 0))
                ...
                (= mainv%sm5_0 (store mainv%sm52_0 mainv%Own_Tracked_Alt_0 0))
                (> mainv%Other_Tracked_Alt_0 0)
                (= mainv%sm6_0 (store mainv%sm56_0 mainv%Other_Tracked_Alt_0 0))
                (> mainv%High_Confidence_0 0)
                (= mainv%sm7_0 (store mainv%sm48_0 mainv%High_Confidence_0 0))
