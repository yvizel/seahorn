...
(constraint (=> (and (mainventry v__VERIFIER_nondet_int_0 vfind_condition_0)
         ...
         (=> (and mainventry.split_0 mainventry_0) (not mainv%_25_0))
         mainventry.split_0)
...
(constraint (=> (and (mainventry v__VERIFIER_nondet_int_0 vfind_condition_0)
         ...
         (=> (and mainventry.split.us_0 mainventry_0) mainv%_25_0)
...
(constraint (=> (and (mainventry.split.us v__VERIFIER_nondet_int_0)
         true
         (= mainv%_26_0 v__VERIFIER_nondet_int_0)
         (= mainv%_28_0 (= mainv%_27_0 0))
         (not mainv%_28_0)
