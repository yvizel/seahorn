...
(constraint (=> (and (mainventry v__VERIFIER_nondet_int_0 vfind_condition_0)
         ...
         (= mainv%_15_0 (= mainv%_4_0 0))
         (=> mainventry.split.us_0 (and mainventry.split.us_0 mainventry_0))
         (=> (and mainventry.split.us_0 mainventry_0) (not mainv%_15_0))
...
(constraint (=> (and (mainventry v__VERIFIER_nondet_int_0 vfind_condition_0)
         ...
         (=> (and mainventry.split_0 mainventry_0) mainv%_15_0)
         mainventry.split_0)
...
(constraint (=> (and (mainventry.split.us v__VERIFIER_nondet_int_0 vfind_condition_0)
         true
         (= mainv%_16_0 v__VERIFIER_nondet_int_0)
         (= mainv%_18_0 (= mainv%_17_0 0))
         (not mainv%_18_0)
...
(constraint (=> (and (mainventry.split!_Cond
         ...
         (= mainv%_26_0 (= mainv%_25_0 mainv%loop.bound_0))
         (=> mainventry.split_1 (and mainventry.split_1 mainventry.split_0))
         (=> (and mainventry.split_1 mainventry.split_0) mainv%_26_0)
         mainventry.split_1)
    (mainventry.split v__VERIFIER_nondet_int_0
                      vfind_condition_0
                      mainv%loop.bound_0)))
(constraint (=> (and (not (mainventry.split!_Cond
         ...
         (=> (and mainvverifier.error_0 mainventry.split_0) (not mainv%_26_0))
         mainvverifier.error_0)
    mainvverifier.error))
