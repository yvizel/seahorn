...
(rule (=> (and (main@entry.split.us @__VERIFIER_nondet_int_0 @find_condition_0)
         ...
         (= main@%_19_0 (= main@%_14_0 0))
         (=> main@entry.split.us_0 (and main@entry.split.us_0 main@entry_0))
         (=> (and main@entry.split.us_0 main@entry_0) (not main@%_19_0))
...
(rule (=> (and (main@entry.split @__VERIFIER_nondet_int_0
         ...
         (=> (and main@entry.split_0 main@entry_0) main@%_19_0)
         main@entry.split_0)
    (main@entry @__VERIFIER_nondet_int_0 @find_condition_0)))
(rule (=> (and (main@entry.split.us @__VERIFIER_nondet_int_0 @find_condition_0)
         true
         true
         (= main@%_20_0 @__VERIFIER_nondet_int_0)
...
(rule (=> (and (main@entry.split!_Cond
         ...
         (= main@%_30_0 (= main@%_29_0 main@%loop.bound_0))
