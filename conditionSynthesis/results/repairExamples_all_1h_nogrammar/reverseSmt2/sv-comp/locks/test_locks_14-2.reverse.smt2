...
(declare-rel main@.backedge (Int Int Int ))
...
(declare-rel main@.backedge!_Cond (Int Int Int ))
...
(declare-var main@.backedge_1 Bool )
...
(rule (let ((a!1 (and (main@.lr.ph.split
                ...
                (not main@%_31_0)
                (= main@%_32_0 (= main@%_28_0 0))
                (= main@%_33_0 (= main@%_4_0 0))
                (=> main@.lr.ph_0 (and main@.lr.ph_0 main@entry_0))
                (=> (and main@.lr.ph_0 main@entry_0) (not main@%_33_0))
                (=> main@.lr.ph_0 (= main@%_34_0 (= main@%_26_0 0)))
                (=> main@.lr.ph.split_0 (and main@.lr.ph.split_0 main@.lr.ph_0))
                (=> (and main@.lr.ph.split_0 main@.lr.ph_0) (not main@%_34_0))
                main@.lr.ph.split_0)))
...
(rule (let ((a!1 (and (main@.lr.ph.split.us.split.split @__VERIFIER_nondet_int_0)
                ...
                (=> (and main@.lr.ph.split.us_0 main@.lr.ph_0) main@%_34_0)
...
(rule (let ((a!1 (and main@verifier.error
                ...
                (=> |tuple(main@.lr.ph.split.us_0, main@verifier.error_0)|
                    main@%_32_0)
                (=> |tuple(main@entry_0, main@verifier.error_0)| main@%_33_0)
                main@verifier.error_0)))
  (=> a!1 (main@entry @__VERIFIER_nondet_int_0 @find_condition_0))))
(rule (=> (and (main@.lr.ph.split.us.split.split @__VERIFIER_nondet_int_0)
         true
         true
         (= main@%_35_0 @__VERIFIER_nondet_int_0)
...
(rule (=> (and (main@.lr.ph.split!_Cond
         ...
         (= main@%.not_0 (xor main@%_32_0 true))
         (= main@%_40_0 (= main@%_39_0 0))
         (= main@%or.cond_0 (and main@%_40_0 main@%.not_0))
         (=> main@.backedge_0 (and main@.backedge_0 main@.lr.ph.split_0))
         true
         main@.backedge_0
         true
         (= main@%_38_0 @find_condition_0)
    ...
    (main@.lr.ph.split
      ...
      @find_condition_0
      main@%loop.bound_0)))
(rule (=> (and (main@.backedge @__VERIFIER_nondet_int_0
                         @find_condition_0
                         main@%loop.bound_0)
         main@verifier.error)
    (main@.lr.ph.split!_Cond
      ...
      @find_condition_0
      main@%loop.bound_0)))
(rule (=> (and (main@.backedge!_Cond
           @__VERIFIER_nondet_int_0
           @find_condition_0
           main@%loop.bound_0)
         true
         (= main@%_41_0 @__VERIFIER_nondet_int_0)
         (= main@%_43_0 (= main@%_42_0 0))
         (not main@%_43_0)
         (= main@%_44_0 @find_condition_0)
         (= main@%_46_0 (= main@%_45_0 main@%loop.bound_0))
         (=> main@.backedge_1 (and main@.backedge_1 main@.backedge_0))
         true
         main@.backedge_1
         true
         (= main@%_41_0 @__VERIFIER_nondet_int_0)
         ...
         (= main@%_44_0 @find_condition_0)
         (= main@%_46_0 (= main@%_45_0 main@%loop.bound_0))
         (=> main@verifier.error_0 (and main@verifier.error_0 main@.backedge_0))
         true
         main@verifier.error_0)
    (main@.backedge @__VERIFIER_nondet_int_0
                    @find_condition_0
                    main@%loop.bound_0)))
(rule (=> (and (main@.backedge @__VERIFIER_nondet_int_0
                         @find_condition_0
