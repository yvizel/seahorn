...
(rule (=> (and (main@entry.split @__VERIFIER_nondet_int_0
         ...
         (= main@%_17_0 (= main@%_14_0 0))
         (=> main@entry.split_0 (and main@entry.split_0 main@entry_0))
         (=> (and main@entry.split_0 main@entry_0) (not main@%_17_0))
         main@entry.split_0)
    (main@entry @__VERIFIER_nondet_int_0 @find_condition_0)))
(rule (=> (and (main@entry.split.us @__VERIFIER_nondet_int_0 @find_condition_0)
         true
         true
         (= main@%_0_0 (= main@%loop.bound_0 0))
         main@%_0_0
         ...
         (=> (and main@entry.split.us_0 main@entry_0) main@%_17_0)
...
(rule (=> (and (main@entry.split.us @__VERIFIER_nondet_int_0 @find_condition_0)
         true
         true
         (= main@%_18_0 @__VERIFIER_nondet_int_0)
         (= main@%_20_0 (= main@%_19_0 0))
         (not main@%_20_0)
         (= main@%_21_0 @find_condition_0)
         (=> main@entry.split.us_1
             (and main@entry.split.us_1 main@entry.split.us_0))
         main@entry.split.us_1)
    (main@entry.split.us @__VERIFIER_nondet_int_0 @find_condition_0)))
...
(rule (=> (and (main@entry.split!_Cond
         ...
         (not main@%_25_0)
         (= main@%_26_0 @find_condition_0)
         (= main@%_28_0 (= main@%_27_0 main@%loop.bound_0))
