...
(define-fun mainv.critedge.i.i ((mainv%sm31_0 (Array Int Int)) (mainv%Alt_Layer_Value_0 Int) (vPositive_RA_Alt_Thresh_0 Int) (mainv%sm28_0 (Array Int Int)) (mainv%Own_Tracked_Alt_0 Int) (mainv%sm30_0 (Array Int Int)) (mainv%Other_Tracked_Alt_0 Int) (mainv%sm36_0 (Array Int Int)) (mainv%Climb_Inhibit_0 Int) (mainv%sm32_0 (Array Int Int)) (mainv%Up_Separation_0 Int) (mainv%sm33_0 (Array Int Int)) (mainv%Down_Separation_0 Int) (mainv%sm35_0 (Array Int Int)) (mainv%Other_Capability_0 Int) (mainv%sm34_0 (Array Int Int)) (mainv%Other_RAC_0 Int) (mainv%sm27_0 (Array Int Int)) (mainv%Two_of_Three_Reports_Valid_0 Int) (mainv%sm40_0 (Array Int Int)) (mainv%sm26_0 (Array Int Int)) (mainv%High_Confidence_0 Int) (mainv%sm29_0 (Array Int Int)) (mainv%Own_Tracked_Alt_Rate_0 Int) (mainv%sm25_0 (Array Int Int)) (mainv%Cur_Vertical_Sep_0 Int) (vg_0 Int) ) Bool
	(let ((a!1 (<= (+ (select mainv%sm32_0 mainv%Up_Separation_0)
      ...
      (a!34 (not (= (select mainv%sm40_0 (+ 8 vPositive_RA_Alt_Thresh_0)) 640))))
...
(define-fun mainvalt_sep_test.exit.i ((mainv%.06.i.i_1 Int) (mainv%sm31_0 (Array Int Int)) (mainv%Alt_Layer_Value_0 Int) (vPositive_RA_Alt_Thresh_0 Int) (mainv%sm28_0 (Array Int Int)) (mainv%Own_Tracked_Alt_0 Int) (mainv%sm30_0 (Array Int Int)) (mainv%Other_Tracked_Alt_0 Int) (mainv%sm36_0 (Array Int Int)) (mainv%Climb_Inhibit_0 Int) (mainv%sm32_0 (Array Int Int)) (mainv%Up_Separation_0 Int) (mainv%sm33_0 (Array Int Int)) (mainv%Down_Separation_0 Int) (mainv%sm35_0 (Array Int Int)) (mainv%Other_Capability_0 Int) (mainv%sm34_0 (Array Int Int)) (mainv%Other_RAC_0 Int) (mainv%sm27_0 (Array Int Int)) (mainv%Two_of_Three_Reports_Valid_0 Int) (mainv%sm40_0 (Array Int Int)) (mainv%sm26_0 (Array Int Int)) (mainv%High_Confidence_0 Int) (mainv%sm29_0 (Array Int Int)) (mainv%Own_Tracked_Alt_Rate_0 Int) (mainv%sm25_0 (Array Int Int)) (mainv%Cur_Vertical_Sep_0 Int) ) Bool
	(let ((a!1 (<= (+ (select mainv%sm32_0 mainv%Up_Separation_0)
      ...
      (a!14 (>= (+ (select mainv%sm33_0 mainv%Down_Separation_0)
                ...
                100))
      (a!22 (not (<= (select mainv%sm40_0 (+ 8 vPositive_RA_Alt_Thresh_0)) 640)))
      (a!35 (or (not (= (select mainv%sm35_0 mainv%Other_Capability_0) 1))
                (not (= mainv%.06.i.i_1 0))
                (<= (select mainv%sm34_0 mainv%Other_RAC_0) 0)))
      (a!38 (or (not (= (select mainv%sm26_0 mainv%High_Confidence_0) 0))
                (not (= mainv%.06.i.i_1 0))))
      (a!39 (or (not (>= (select mainv%sm29_0 mainv%Own_Tracked_Alt_Rate_0) 601))
                (not (= mainv%.06.i.i_1 0))))
      (a!40 (or (not (<= (select mainv%sm25_0 mainv%Cur_Vertical_Sep_0) 600))
                (not (= mainv%.06.i.i_1 0))))
      (a!41 (>= (+ (select mainv%sm28_0 mainv%Own_Tracked_Alt_0)
                   (* (- 1) (select mainv%sm30_0 mainv%Other_Tracked_Alt_0)))
                0))
      (a!44 (>= (+ (select mainv%sm30_0 mainv%Other_Tracked_Alt_0)
                   (* (- 1) (select mainv%sm28_0 mainv%Own_Tracked_Alt_0)))
                0))
      (a!46 (or (not (= (select mainv%sm35_0 mainv%Other_Capability_0) 1))
                (not (= mainv%.06.i.i_1 0))
                (not (= (select mainv%sm27_0 mainv%Two_of_Three_Reports_Valid_0)
                        0))))
      (a!47 (not (>= (select mainv%sm40_0 (+ 4 vPositive_RA_Alt_Thresh_0)) 500)))
      (a!48 (not (>= (select mainv%sm40_0 (+ 8 vPositive_RA_Alt_Thresh_0)) 640))))
(let ((a!3 (or (<= (select mainv%sm26_0 mainv%High_Confidence_0) 0)
      ...
      (a!49 (or (not (= mainv%.06.i.i_1 0))
                ...
                a!48
                (not a!44)))
      (a!50 (or (not (= (select mainv%sm36_0 mainv%Climb_Inhibit_0) 0))
                (not (= mainv%.06.i.i_1 0))
                (not a!11)
                (not a!44)))
      (a!51 (or (not (>= (select mainv%sm33_0 mainv%Down_Separation_0) 740))
                (not (= mainv%.06.i.i_1 0))
                (not (<= a!7 740))
                (not a!44)))
      (a!52 (or (not (= (select mainv%sm31_0 mainv%Alt_Layer_Value_0) 3))
                (not a!41)
                (not (= mainv%.06.i.i_1 0))
  ...
  (and a!3
       ...
       a!42
       a!43
       (or a!1 (not a!41) (not (= mainv%.06.i.i_1 0)))
       (or (not a!41)
           (not (= mainv%.06.i.i_1 0))
           (<= (select mainv%sm36_0 mainv%Climb_Inhibit_0) 0)
           (not a!5))
       ...
       a!49
       a!50
       (or (not (= mainv%.06.i.i_1 0)) (not a!14) (not a!44))
       a!51
       a!52
       a!53
       a!54)))
