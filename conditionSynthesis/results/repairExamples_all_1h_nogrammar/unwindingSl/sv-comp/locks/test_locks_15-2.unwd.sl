...
(constraint (=> (and true
         ...
         (= mainv%_31_0 (= mainv%_2_0 0))
         (=> mainventry.split.us_0 (and mainventry.split.us_0 mainventry_0))
         (=> (and mainventry.split.us_0 mainventry_0) (not mainv%_31_0))
...
(constraint (=> (and true
         ...
         (=> (and mainventry.split_0 mainventry_0) mainv%_31_0)
         mainventry.split_0)
...
(constraint (=> (and (mainventry.split!_Cond
         ...
         (= mainv%_42_0 (= mainv%_41_0 mainv%loop.bound_0))
         (=> mainventry.split_1 (and mainventry.split_1 mainventry.split_0))
         (=> (and mainventry.split_1 mainventry.split_0) mainv%_42_0)
         mainventry.split_1)
    (mainventry.split v__VERIFIER_nondet_int_0
                      vfind_condition_0
                      mainv%loop.bound_0)))
(constraint (=> (and (not (mainventry.split!_Cond
         ...
         (=> (and mainvverifier.error_0 mainventry.split_0) (not mainv%_42_0))
         mainvverifier.error_0
         true
