...
(constraint (let ((a!1 (and true
                ...
                (=> (and mainv.lr.ph_0 mainv_10_0)
                    (= mainv%.13.i6_0 mainv%.02.i_0))
                (=> (and mainv.lr.ph_0 mainv_10_0)
                    (= mainv%.04.i5_0 mainv%_12_0))
                (=> (and mainv.lr.ph_0 mainv_10_0)
                    (= mainv%.0.i7_1 mainv%.0.i7_0))
                (=> (and mainv.lr.ph_0 mainv_10_0)
                    (= mainv%.13.i6_1 mainv%.13.i6_0))
                (=> (and mainv.lr.ph_0 mainv_10_0)
                    (= mainv%.04.i5_1 mainv%.04.i5_0))
                mainv.lr.ph_0)))
  (=> a!1
      (mainv.lr.ph vg_0
                   mainv%.04.i5_1
...
(constraint (=> (and (mainv.lr.ph!_Cond
    ...
    (mainv.lr.ph vg_0
                 ...
                 mainv%.13.i6_2
                 vfind_condition_0)))
(constraint (let ((a!1 (and (not (mainv.lr.ph!_Cond
                       mainv%.0.i7_2
                       mainv%.13.i6_2
                       mainv%.04.i5_2
                       vg_0
