(synth-fun mainv._crit_edge!_Cond ((x0 Int) (x1 Int) (x2 Int) ) Bool
)
...
(constraint (let ((a!1 (and true
                ...
                (=> (and mainv_10_0 mainv_9_0) (= mainv%.0.i_0 mainv%_7_0))
                (=> |tuple(mainventry_0, mainv_10_0)| (= mainv%.0.i_1 9))
                (=> (and mainv_10_0 mainv_9_0) (= mainv%.0.i_2 mainv%.0.i_0))
                (=> |tuple(mainventry_0, mainv_10_0)|
                    (= mainv%.0.i_2 mainv%.0.i_1))
                (=> mainv_10_0 (= mainv%_11_0 (> mainv%_2_0 0)))
                (=> mainv.lr.ph_0 (and mainv.lr.ph_0 mainv_10_0))
                (=> (and mainv.lr.ph_0 mainv_10_0) mainv%_11_0)
                (=> (and mainv.lr.ph_0 mainv_10_0)
                    (= mainv%.1.i2_0 mainv%.0.i_2))
                (=> (and mainv.lr.ph_0 mainv_10_0)
  ...
  (=> a!1
      (mainv.lr.ph vg_0
                   ...
                   mainv%.01.i1_1
                   mainv%loop.bound_0))))
(constraint (=> (and (mainv.lr.ph vg_0
                      vfind_condition_0
                      mainv%.1.i2_0
                      mainv%.01.i1_0
                      mainv%loop.bound_0)
         true
         (= mainv%_12_0 (+ mainv%.1.i2_0 mainv%.01.i1_0))
         (= mainv%_13_0 (+ mainv%.01.i1_0 (- 3)))
         (= mainv%_14_0 (> mainv%.01.i1_0 mainv%loop.bound_0))
         (=> mainv.lr.ph_1 (and mainv.lr.ph_1 mainv.lr.ph_0))
         (=> (and mainv.lr.ph_1 mainv.lr.ph_0) mainv%_14_0)
         (=> (and mainv.lr.ph_1 mainv.lr.ph_0) (= mainv%.1.i2_1 mainv%_12_0))
         (=> (and mainv.lr.ph_1 mainv.lr.ph_0) (= mainv%.01.i1_1 mainv%_13_0))
...
(constraint (=> (and (mainv.lr.ph vg_0
         ...
         (=> (and mainv._crit_edge_0 mainv.lr.ph_0) (not mainv%_14_0))
         (=> (and mainv._crit_edge_0 mainv.lr.ph_0)
             (= mainv%.1.i.lcssa_0 mainv%_12_0))
         (=> (and mainv._crit_edge_0 mainv.lr.ph_0)
             (= mainv%.1.i.lcssa_1 mainv%.1.i.lcssa_0))
         mainv._crit_edge_0
         (mainv._crit_edge!_Cond vg_0 mainv%.1.i.lcssa_0 mainv%.2.i_1)
         true
         ...
         true
         (= mainv%_18_0 vg_0)
         (= mainv%_19_0 (+ mainv%.1.i.lcssa_0 (- 1)))
         (=> mainvverifier.error_0 (and mainvverifier.error_0 mainv_17_0))
...
(constraint (=> (and (mainv.lr.ph vg_0
         ...
         (=> (and mainv._crit_edge_0 mainv.lr.ph_0)
             (= mainv%.1.i.lcssa_1 mainv%.1.i.lcssa_0))
         mainv._crit_edge_0
         (not (mainv._crit_edge!_Cond vg_0 mainv%.1.i.lcssa_0 mainv%.2.i_1))
         true
         (= mainv%_15_0 vfind_condition_0)
         (=> mainvverifier.error_0
             (and mainvverifier.error_0 mainv._crit_edge_0))
         (=> (and mainvverifier.error_0 mainv._crit_edge_0) (not mainv%_16_0))
         (=> (and mainvverifier.error_0 mainv._crit_edge_0)
             (= mainv%.2.i_0 mainv%.1.i.lcssa_0))
         (=> (and mainvverifier.error_0 mainv._crit_edge_0)
             (= mainv%.2.i_1 mainv%.2.i_0))
         mainvverifier.error_0
         true
...
(constraint (let ((a!1 (and true
                ...
                (=> (and mainv._crit_edge_0 mainv_10_0) (not mainv%_11_0))
                (=> (and mainv._crit_edge_0 mainv_10_0)
                    (= mainv%.1.i.lcssa_0 mainv%.0.i_2))
                (=> (and mainv._crit_edge_0 mainv_10_0)
                    (= mainv%.1.i.lcssa_1 mainv%.1.i.lcssa_0))
                mainv._crit_edge_0
                (mainv._crit_edge!_Cond vg_0 mainv%.1.i.lcssa_0 mainv%.2.i_1)
