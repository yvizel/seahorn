...
(constraint (let ((a!1 (and true
  ...
  (=> a!1
      (mainv_15 vg_0
                ...
                mainv%.0.i_1
                vfind_condition_0))))
(constraint (=> (and (mainv_15!_Cond vfind_condition_0
                         vg_0
                         mainv%loop.bound_0
                         mainv%.04.i_0
                         mainv%.13.i_0
    ...
    (mainv_15 vg_0
              ...
              mainv%.0.i_1
              vfind_condition_0)))
(constraint (let ((a!1 (and (mainv_15!_Cond vfind_condition_0
                                vg_0
                                mainv%loop.bound_0
                                mainv%.04.i_0
                                mainv%.13.i_0
                ...
                mainvverifier.error.split_0)))
  (=> a!1 false)))
(constraint (=> (and (not (mainv_15!_Cond vfind_condition_0
                              vg_0
                              mainv%loop.bound_0
                              mainv%.04.i_0
                              mainv%.13.i_0
    ...
    (mainv_15 vg_0
              ...
              mainv%.0.i_1
              vfind_condition_0)))
(constraint (let ((a!1 (and (not (mainv_15!_Cond vfind_condition_0
                                     vg_0
                                     mainv%loop.bound_0
                                     mainv%.04.i_0
                                     mainv%.13.i_0
