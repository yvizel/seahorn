...
(let ((a!21 (and true
                 ...
                 (= mainv%sm3_0 (store mainv%sm57_0 mainv%Down_Separation_0 0))
                 (> mainv%Cur_Vertical_Sep_0 0)
                 (= mainv%sm4_0 (store mainv%sm47_0 mainv%Cur_Vertical_Sep_0 0))
                 (> mainv%Own_Tracked_Alt_0 0)
                 (= mainv%sm5_0 (store mainv%sm53_0 mainv%Own_Tracked_Alt_0 0))
