...
(declare-rel main@.lr.ph (Bool Int (Array Int Int) Int Int Int Int Int Int ))
(declare-rel main@_43 (Bool Int (Array Int Int) Int Int Int Int Int ))
(declare-rel main@_40 (Bool Int (Array Int Int) Int Int Int Int Int ))
(declare-rel main@binary_search.exit.i.split ())
(declare-rel main@entry!_BAD ())
(declare-rel main@.lr.ph!_Cond (Int Int Int (Array Int Int) Int Bool Int Int Int ))
...
(declare-var main@%.05.i.i514_2 Int )
(declare-var main@%.02.i2.i613_2 Int )
...
(declare-var main@%_37_2 Int )
(declare-var |tuple(main@_45_0, main@binary_search.exit.i_0)| Bool )
(declare-var |tuple(main@_31_0, main@binary_search.exit.i_0)| Bool )
...
(rule (let ((a!1 (= main@%_4_0 (+ (+ main@%_0_0 (* 0 20)) (* 0 4))))
      ...
      (a!6 (= main@%_28_0 (+ (+ main@%_0_0 (* 0 20)) (* 2 4)))))
  (=> (and (main@.lr.ph main@%or.cond12_0
                        main@%_0_0
                        main@%sm4_0
                        main@%_18_0
                        main@%_37_1
           ...
           a!6
           (or (<= main@%_0_0 0) (> main@%_28_0 0))
           (> main@%_0_0 0)
           (= main@%_29_0 (select main@%sm2_0 main@%_28_0))
           (= main@%_30_0 (= main@%_29_0 main@%_18_0))
           (=> main@.lr.ph_0 (and main@.lr.ph_0 main@entry_0))
           (=> (and main@.lr.ph_0 main@entry_0) (not main@%_30_0))
           (=> (and main@.lr.ph_0 main@entry_0) (= main@%_37_0 2))
           (=> (and main@.lr.ph_0 main@entry_0) (= main@%.05.i.i514_0 0))
           (=> (and main@.lr.ph_0 main@entry_0) (= main@%.02.i2.i613_0 4))
           (=> (and main@.lr.ph_0 main@entry_0) (= main@%_37_1 main@%_37_0))
...
(let ((a!7 (and main@binary_search.exit.i.split
                ...
                (=> (and main@binary_search.exit.i_0 main@entry_0) main@%_30_0)
                (=> (and main@binary_search.exit.i_0 main@entry_0)
                    (= main@%.2.i.i_0 true))
                (=> (and main@binary_search.exit.i_0 main@entry_0)
...
(rule (let ((a!1 (=> main@_31_0
               (= main@%_34_0 (+ main@%_0_0 (* 0 20) (* main@%_33_0 4))))))
(let ((a!2 (and (main@.lr.ph main@%or.cond12_0
                             main@%_0_0
                             main@%sm4_0
                             main@%_18_0
                             main@%_37_2
                ...
                true
                true
                (= main@%_44_0 (+ main@%_37_0 1))
                (=> main@_45_0 (and main@_45_0 main@_43_0))
                (=> (and main@_45_0 main@_43_0) (= main@%.27.i.i_0 main@%_44_0))
                (=> (and main@_45_0 main@_43_0)
                    (= main@%.24.i.i_0 main@%.02.i2.i613_0))
                (=> (and main@_45_0 main@_43_0)
                    (= main@%.27.i.i_1 main@%.27.i.i_0))
                (=> (and main@_45_0 main@_43_0)
                    (= main@%.24.i.i_1 main@%.24.i.i_0))
                (=> main@_45_0
                    (= main@%_46_0 (< main@%.24.i.i_1 main@%.27.i.i_1)))
                (=> main@_31_0 (and main@_31_0 main@_45_0))
                (=> (and main@_31_0 main@_45_0) (not main@%_46_0))
                (=> main@_31_0
                    (= main@%_32_0 (+ main@%.24.i.i_1 main@%.27.i.i_1)))
                (=> main@_31_0 (= main@%_33_0 (div main@%_32_0 2)))
                a!1
                (=> main@_31_0 (or (<= main@%_0_0 0) (> main@%_34_0 0)))
                (=> main@_31_0 (> main@%_0_0 0))
                (=> main@_31_0 (= main@%_35_0 (select main@%sm4_0 main@%_34_0)))
                (=> main@_31_0 (= main@%_36_0 (= main@%_35_0 main@%_18_0)))
                (=> main@.lr.ph_0 (and main@.lr.ph_0 main@_31_0))
                (=> (and main@.lr.ph_0 main@_31_0) (not main@%_36_0))
                (=> (and main@.lr.ph_0 main@_31_0) (= main@%_37_1 main@%_33_0))
                (=> (and main@.lr.ph_0 main@_31_0)
                    (= main@%.05.i.i514_0 main@%.27.i.i_1))
                (=> (and main@.lr.ph_0 main@_31_0)
                    (= main@%.02.i2.i613_1 main@%.24.i.i_1))
                (=> (and main@.lr.ph_0 main@_31_0) (= main@%_37_2 main@%_37_1))
                (=> (and main@.lr.ph_0 main@_31_0)
                    (= main@%.05.i.i514_1 main@%.05.i.i514_0))
                (=> (and main@.lr.ph_0 main@_31_0)
                    (= main@%.02.i2.i613_2 main@%.02.i2.i613_1))
                main@.lr.ph_0)))
  (=> a!2
      (main@_43 main@%or.cond12_0
                main@%_0_0
                main@%sm4_0
                main@%_18_0
                main@%_37_0
...
(let ((a!2 (and main@binary_search.exit.i.split
                ...
                (=> main@_31_0 (= main@%_35_0 (select main@%sm4_0 main@%_34_0)))
                (=> main@_31_0 (= main@%_36_0 (= main@%_35_0 main@%_18_0)))
                (=> |tuple(main@_45_0, main@binary_search.exit.i_0)| main@_45_0)
                (=> |tuple(main@_31_0, main@binary_search.exit.i_0)| main@_31_0)
                (=> main@binary_search.exit.i_0
                    (or |tuple(main@_45_0, main@binary_search.exit.i_0)|
                        |tuple(main@_31_0, main@binary_search.exit.i_0)|))
                (=> |tuple(main@_45_0, main@binary_search.exit.i_0)|
                    main@%_46_0)
                (=> |tuple(main@_31_0, main@binary_search.exit.i_0)|
                    main@%_36_0)
                (=> |tuple(main@_45_0, main@binary_search.exit.i_0)|
...
(let ((a!2 (and (main@.lr.ph main@%or.cond12_0
                ...
                true
                (= main@%_41_0 @g_0)
                (= main@%_42_0 (+ main@%_37_0 (- 1)))
                (=> main@_45_0 (and main@_45_0 main@_40_0))
                (=> (and main@_45_0 main@_40_0)
                    (= main@%.27.i.i_0 main@%.05.i.i514_0))
                (=> (and main@_45_0 main@_40_0) (= main@%.24.i.i_0 main@%_42_0))
                (=> (and main@_45_0 main@_40_0)
                    (= main@%.27.i.i_1 main@%.27.i.i_0))
                (=> (and main@_45_0 main@_40_0)
                    (= main@%.24.i.i_1 main@%.24.i.i_0))
                ...
                (=> (and main@.lr.ph_0 main@_31_0) (= main@%_37_1 main@%_33_0))
                (=> (and main@.lr.ph_0 main@_31_0)
                    (= main@%.05.i.i514_1 main@%.27.i.i_1))
                (=> (and main@.lr.ph_0 main@_31_0)
                    (= main@%.02.i2.i613_0 main@%.24.i.i_1))
                (=> (and main@.lr.ph_0 main@_31_0) (= main@%_37_2 main@%_37_1))
                (=> (and main@.lr.ph_0 main@_31_0)
                    (= main@%.05.i.i514_2 main@%.05.i.i514_1))
                (=> (and main@.lr.ph_0 main@_31_0)
                    (= main@%.02.i2.i613_1 main@%.02.i2.i613_0))
                main@.lr.ph_0)))
  (=> a!2
      (main@_40 main@%or.cond12_0
                main@%_0_0
                main@%sm4_0
                main@%_18_0
                main@%_37_0
...
(rule (=> (and (main@.lr.ph!_Cond
           ...
           main@%.02.i2.i613_0)
         true
         (= main@%_38_0 @find_condition_0)
         (=> main@_43_0 (and main@_43_0 main@.lr.ph_0))
         true
         main@_43_0
         true
         (= main@%_38_0 @find_condition_0)
         (=> main@_40_0 (and main@_40_0 main@.lr.ph_0))
         true
         main@_40_0)
    (main@.lr.ph main@%or.cond12_0
                 ...
                 @g_0
                 @find_condition_0)))
(rule (=> (and (main@_43 main@%or.cond12_0
                   main@%_0_0
                   main@%sm4_0
                   main@%_18_0
                   main@%_37_0
