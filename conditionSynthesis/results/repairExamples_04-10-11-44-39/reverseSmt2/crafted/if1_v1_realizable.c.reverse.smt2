...
(declare-rel main@entry!_Then (Int Int Int Int Int Int Int ))
(declare-rel main@entry!_Else (Int Int Int Int Int Int Int ))
(declare-rel main@entry!_BAD ())
(declare-rel main@entry!_Cond (Int Int Int Int Int Int Int ))
...
(rule (=> (and main@entry.split
         ...
         true
         true
         (= main@%.0.p.i_0 main@%_4_0)
         (= main@%.0.i_0 (+ main@%.0.p.i_0 2))
         (= main@%_6_0 (> main@%.0.i_0 0))
         (not main@%_6_0)
