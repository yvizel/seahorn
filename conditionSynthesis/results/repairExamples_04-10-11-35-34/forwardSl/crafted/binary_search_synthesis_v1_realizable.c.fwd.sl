...
(synth-fun mainv_30 ((x0 Bool) (x1 Int) (x2 Int) (x3 Int) (x4 Int) (x5 (Array Int Int)) (x6 Int) ) Bool)
(synth-fun mainvbinary_search.exit.i ((x0 Bool) (x1 Bool) ) Bool)
(synth-fun mainvbinary_search.exit.i.split () Bool)
(synth-fun mainventry!_BAD () Bool)
(synth-fun mainventry!_Cond ((x0 Int) (x1 Int) (x2 (Array Int Int)) (x3 Int) (x4 Bool) (x5 Int) (x6 Int) (x7 Int) (x8 Bool) ) Bool)
(synth-fun mainv_30!_Cond ((x0 Int) (x1 Int) (x2 (Array Int Int)) (x3 Int) (x4 Bool) (x5 Int) (x6 Int) (x7 Int) (x8 Bool) ) Bool)
(synth-fun mainventry!_FwdCond ((x0 Int) (x1 Int) ) Bool)
(synth-fun mainv_30!_FwdCond ((x0 Bool) (x1 Int) (x2 Int) (x3 Int) (x4 Int) (x5 (Array Int Int)) (x6 Int) ) Bool)
...
(constraint (let ((a!1 (and (mainv.lr.ph mainv%or.cond12_0
                             vfind_condition_0
                             mainv%_35_0
                             mainv%.05.i.i514_0
                             mainv%.02.i2.i613_0
                             ...
                             mainv%_18_0)
                true
                (= mainv%_36_0 (+ mainv%_0_0 (* 0 20) (* mainv%_35_0 4)))
                (or (<= mainv%_0_0 0) (> mainv%_36_0 0))
                (> mainv%_0_0 0)
                (= mainv%_37_0 (select mainv%sm4_0 mainv%_36_0))
                (= mainv%_38_0 (> mainv%_37_0 mainv%_18_0))
                (= mainv%_39_0 (+ mainv%_35_0 (- 1)))
                (= mainv%_40_0 (+ mainv%_35_0 1))
                (= mainv%.16.i.i_0
                   (ite mainv%_38_0 mainv%.05.i.i514_0 mainv%_40_0))
                (= mainv%.13.i.i_0
                   (ite mainv%_38_0 mainv%_39_0 mainv%.02.i2.i613_0))
                (= mainv%_41_0 (< mainv%.13.i.i_0 mainv%.16.i.i_0))
                (=> mainv_30_0 (and mainv_30_0 mainv.lr.ph_0))
                (=> (and mainv_30_0 mainv.lr.ph_0) (not mainv%_41_0))
                mainv_30_0)))
  (=> a!1
      (mainv_30 mainv%or.cond12_0
                mainv%.13.i.i_0
                mainv%.16.i.i_0
                vfind_condition_0
                mainv%_0_0
...
(constraint (let ((a!1 (and (mainv.lr.ph mainv%or.cond12_0
                ...
                (=> (and mainvbinary_search.exit.i_0 mainv.lr.ph_0) mainv%_41_0)
                (=> (and mainvbinary_search.exit.i_0 mainv.lr.ph_0)
                    (= mainv%.2.i.i_0 false))
                (=> (and mainvbinary_search.exit.i_0 mainv.lr.ph_0)
                    (= mainv%.2.i.i_1 mainv%.2.i.i_0))
                mainvbinary_search.exit.i_0)))
  (=> a!1 (mainvbinary_search.exit.i mainv%or.cond12_0 mainv%.2.i.i_1))))
(constraint (=> (and (mainvbinary_search.exit.i mainv%or.cond12_0 mainv%.2.i.i_0)
         true
         (= mainv%_42_0 (= mainv%or.cond12_0 mainv%.2.i.i_0))
         (not mainv%_42_0)
...
(constraint (let ((a!1 (= mainv%_4_0 (+ (+ mainv%_0_0 (* 0 20)) (* 0 4))))
  ...
  (=> (and (mainventry!_FwdCond vfind_condition_0 vnd_0)
           ...
           (=> (and mainv.lr.ph_0 mainventry_0) (not mainv%_29_0))
           (=> (and mainv.lr.ph_0 mainventry_0) (= mainv%_35_0 2))
           (=> (and mainv.lr.ph_0 mainventry_0) (= mainv%.05.i.i514_0 0))
           (=> (and mainv.lr.ph_0 mainventry_0) (= mainv%.02.i2.i613_0 4))
           (=> (and mainv.lr.ph_0 mainventry_0) (= mainv%_35_1 mainv%_35_0))
...
(constraint (let ((a!1 (= mainv%_4_0 (+ (+ mainv%_0_0 (* 0 20)) (* 0 4))))
  ...
  (=> (and (not (mainventry!_FwdCond vfind_condition_0 vnd_0))
           ...
           (=> (and mainvbinary_search.exit.i_0 mainventry_0) mainv%_29_0)
           (=> (and mainvbinary_search.exit.i_0 mainventry_0)
               (= mainv%.2.i.i_0 true))
           (=> (and mainvbinary_search.exit.i_0 mainventry_0)
               (= mainv%.2.i.i_1 mainv%.2.i.i_0))
           mainvbinary_search.exit.i_0)
      (mainvbinary_search.exit.i mainv%or.cond12_0 mainv%.2.i.i_1))))
(constraint (=> (and (mainv_30!_FwdCond
           mainv%or.cond12_0
           mainv%.13.i.i_0
           mainv%.16.i.i_0
           vfind_condition_0
         ...
         (mainv_30 mainv%or.cond12_0
                   ...
                   mainv%_18_0)
         true
         (= mainv%_31_0 (+ mainv%.13.i.i_0 mainv%.16.i.i_0))
         (= mainv%_32_0 (div mainv%_31_0 2))
         (= mainv%_33_0 vfind_condition_0)
         (=> mainv.lr.ph_0 (and mainv.lr.ph_0 mainv_30_0))
         (=> (and mainv.lr.ph_0 mainv_30_0) (not mainv%_34_0))
         (=> (and mainv.lr.ph_0 mainv_30_0) (= mainv%_35_0 mainv%_32_0))
         (=> (and mainv.lr.ph_0 mainv_30_0)
             (= mainv%.05.i.i514_0 mainv%.16.i.i_0))
         (=> (and mainv.lr.ph_0 mainv_30_0)
             (= mainv%.02.i2.i613_0 mainv%.13.i.i_0))
         (=> (and mainv.lr.ph_0 mainv_30_0) (= mainv%_35_1 mainv%_35_0))
         (=> (and mainv.lr.ph_0 mainv_30_0)
             (= mainv%.05.i.i514_1 mainv%.05.i.i514_0))
         (=> (and mainv.lr.ph_0 mainv_30_0)
             (= mainv%.02.i2.i613_1 mainv%.02.i2.i613_0))
    ...
    (mainv.lr.ph mainv%or.cond12_0
                 ...
                 mainv%sm4_0
                 mainv%_18_0)))
(constraint (=> (and (not (mainv_30!_FwdCond
                mainv%or.cond12_0
                mainv%.13.i.i_0
                mainv%.16.i.i_0
                vfind_condition_0
         ...
         (= mainv%_33_0 vfind_condition_0)
         (=> mainvbinary_search.exit.i_0
             (and mainvbinary_search.exit.i_0 mainv_30_0))
         (=> (and mainvbinary_search.exit.i_0 mainv_30_0) mainv%_34_0)
         (=> (and mainvbinary_search.exit.i_0 mainv_30_0)
             (= mainv%.2.i.i_0 true))
         (=> (and mainvbinary_search.exit.i_0 mainv_30_0)
             (= mainv%.2.i.i_1 mainv%.2.i.i_0))
