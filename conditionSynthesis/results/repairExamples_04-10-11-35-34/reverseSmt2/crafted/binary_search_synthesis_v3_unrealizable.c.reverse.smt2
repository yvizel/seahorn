...
(declare-rel main@_25 (Bool Int Int Int Int (Array Int Int) Int ))
(declare-rel main@binary_search.exit.i (Bool ))
(declare-rel main@binary_search.exit.i.split ())
(declare-rel main@entry!_BAD ())
(declare-rel main@entry!_Cond (Int Int (Array Int Int) Int Bool Int Int Int ))
(declare-rel main@_25!_Cond (Int Int (Array Int Int) Int Bool Int Int Int ))
...
(declare-var main@%.05.i.i513_0 Int )
(declare-var main@%.02.i2.i612_0 Int )
(declare-var main@%_30_1 Int )
(declare-var main@%.05.i.i513_1 Int )
(declare-var main@%.02.i2.i612_1 Int )
...
(rule (let ((a!1 (and (main@_25 main@%not.or.cond11_0
                          main@%.13.i.i_0
                          main@%.16.i.i_0
                          @find_condition_0
                          main@%_0_0
  ...
  (=> a!1
      (main@.lr.ph main@%not.or.cond11_0
                   ...
                   main@%sm3_0
                   main@%_15_0))))
(rule (let ((a!1 (and (main@binary_search.exit.i main@%not.or.cond11_0)
                true
                true
                (= main@%_31_0 (+ main@%_0_0 (* 0 20) (* main@%_30_0 4)))
                (or (<= main@%_0_0 0) (> main@%_31_0 0))
...
(rule (=> (and main@binary_search.exit.i.split
         ...
         main@binary_search.exit.i.split_0)
    (main@binary_search.exit.i main@%not.or.cond11_0)))
...
(rule (let ((a!1 (= main@%_4_0 (+ (+ main@%_0_0 (* 0 20)) (* 0 4))))
  ...
  (=> (and (main@entry!_Cond @find_condition_0
           ...
           main@%_18_0
           true
           (= main@%_19_0 (= main@%_3_0 main@%_15_0))
           (= main@%_20_0 (= main@%_6_0 main@%_15_0))
           (= main@%or.cond_0 (or main@%_19_0 main@%_20_0))
           (= main@%_21_0 (= main@%_9_0 main@%_15_0))
           (= main@%or.cond10_0 (or main@%or.cond_0 main@%_21_0))
           (= main@%_22_0 (= main@%_12_0 main@%_15_0))
           (= main@%or.cond11_0 (or main@%or.cond10_0 main@%_22_0))
           ...
           (=> (and main@.lr.ph_0 main@entry_0) (= main@%.05.i.i513_0 0))
           (=> (and main@.lr.ph_0 main@entry_0) (= main@%.02.i2.i612_0 4))
           (=> (and main@.lr.ph_0 main@entry_0) (= main@%_30_1 main@%_30_0))
           (=> (and main@.lr.ph_0 main@entry_0)
               (= main@%.05.i.i513_1 main@%.05.i.i513_0))
           (=> (and main@.lr.ph_0 main@entry_0)
               (= main@%.02.i2.i612_1 main@%.02.i2.i612_0))
           main@.lr.ph_0
           true
           (> main@%_0_0 0)
           (= main@%_1_0 main@%_0_0)
...
(rule (=> (and (main@.lr.ph main@%not.or.cond11_0
                      @find_condition_0
                      main@%_30_1
                      main@%.05.i.i513_1
                      main@%.02.i2.i612_1
...
(rule (=> (and (main@_25!_Cond @find_condition_0
         ...
         (=> (and main@.lr.ph_0 main@_25_0)
             (= main@%.05.i.i513_0 main@%.16.i.i_0))
         (=> (and main@.lr.ph_0 main@_25_0)
             (= main@%.02.i2.i612_0 main@%.13.i.i_0))
