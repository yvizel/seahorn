...
(let ((a!5 (and (mainventry vg_0 vfind_condition_0 mainv%sm47_0 vnd_0)
                true
                ...
                (= mainv%sm7_0 (store mainv%sm46_0 mainv%High_Confidence_0 0))
                ...
                (> mainv%Other_RAC_0 0)
                (= mainv%sm11_0 (store mainv%sm57_0 mainv%Other_RAC_0 0))
