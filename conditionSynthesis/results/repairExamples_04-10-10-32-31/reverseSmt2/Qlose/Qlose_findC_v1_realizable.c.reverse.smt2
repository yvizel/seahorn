...
(declare-rel main@.lr.ph5.preheader (Int (Array Int Int) Int Int Int Int Int ))
(declare-rel main@.lr.ph (Int (Array Int Int) Int Int Int Int Int Int ))
(declare-rel main@.lr.ph5 (Int (Array Int Int) Int Int Int Int Int Int ))
(declare-rel main@FindC.exit.i (Int Int (Array Int Int) Int Int Int ))
(declare-rel main@.lr.ph11 (Int Int (Array Int Int) Int Int Int ))
(declare-rel main@AllRepair_correct_FindC.exit.i.split ())
(declare-rel main@entry!_BAD ())
(declare-rel main@.lr.ph5.preheader!_Cond (Int Int Int Int (Array Int Int) Int Int Int Int ))
(declare-rel main@.lr.ph5!_Cond (Int Int Int Int (Array Int Int) Int Int Int Int ))
...
(declare-var main@%.02.i1.i110_2 Int )
...
(declare-var main@%.02.i1.i110_0 Int )
(declare-var main@%.02.i1.i110_1 Int )
...
(declare-var |tuple(main@.lr.ph11_0, main@AllRepair_correct_FindC.exit.i_0)| Bool )
...
(rule (let ((a!1 (= main@%_2_0 (+ (+ main@%_1_0 (* 0 7)) (* 0 1))))
  ...
  (=> (and (main@.lr.ph5.preheader
           ...
           (=> (and main@.lr.ph5.preheader_0 main@entry_0) main@%_29_0)
           main@.lr.ph5.preheader_0)
...
(rule (let ((a!1 (= main@%_2_0 (+ (+ main@%_1_0 (* 0 7)) (* 0 1))))
  ...
  (=> (and (main@FindC.exit.i
           ...
           main@%_28_0
           (= main@%_29_0 (> main@%_26_0 0))
           (=> main@FindC.exit.i_0 (and main@FindC.exit.i_0 main@entry_0))
           (=> (and main@FindC.exit.i_0 main@entry_0) (not main@%_29_0))
           (=> (and main@FindC.exit.i_0 main@entry_0) (= main@%.01.i.i_0 0))
           (=> (and main@FindC.exit.i_0 main@entry_0)
...
(rule (=> (and (main@.lr.ph5 main@%_1_0
         ...
         true
         true
         (= main@%_34_0 (< main@%_33_0 main@%_26_0))
         (=> main@.lr.ph5_0 (and main@.lr.ph5_0 main@.lr.ph_0))
         (=> (and main@.lr.ph5_0 main@.lr.ph_0) main@%_34_0)
         main@.lr.ph5_0)
...
(rule (=> (and (main@FindC.exit.i
         ...
         (=> (and main@FindC.exit.i_0 main@.lr.ph_0) (not main@%_34_0))
    ...
    (main@.lr.ph main@%_1_0
                 ...
                 main@%loop.bound_0
                 main@%_33_0)))
(rule (let ((a!1 (and (main@.lr.ph11 main@%.01.i.i_0
                               main@%_1_0
                               main@%sm6_0
                               main@%_24_0
                               main@%.02.i1.i110_1
                ...
                true
                true
                (= main@%_39_0 (< main@%_26_0 0))
                (=> main@.lr.ph.preheader_0
                    (and main@.lr.ph.preheader_0 main@FindC.exit.i_0))
                (=> (and main@.lr.ph.preheader_0 main@FindC.exit.i_0)
                    (not main@%_39_0))
                (=> main@.lr.ph.preheader_0
                    (= main@%_40_0 (= main@%_4_0 main@%_24_0)))
                (=> main@.lr.ph11_0
                    (and main@.lr.ph11_0 main@.lr.ph.preheader_0))
                (=> (and main@.lr.ph11_0 main@.lr.ph.preheader_0)
                    (not main@%_40_0))
                (=> (and main@.lr.ph11_0 main@.lr.ph.preheader_0)
                    (= main@%.02.i1.i110_0 0))
                (=> (and main@.lr.ph11_0 main@.lr.ph.preheader_0)
                    (= main@%.02.i1.i110_1 main@%.02.i1.i110_0))
                main@.lr.ph11_0)))
  (=> a!1
      (main@FindC.exit.i
        main@%.01.i.i_0
...
(rule (let ((a!1 (and main@AllRepair_correct_FindC.exit.i.split
                ...
                (=> main@AllRepair_correct_FindC.exit.i_0
                    (= main@%_44_0 (= main@%.01.i.i_0 main@%.01.i2.i_2)))
                (=> main@AllRepair_correct_FindC.exit.i_0 (not main@%_44_0))
...
(rule (let ((a!1 (=> main@..lr.ph_crit_edge_0
               (= main@%.phi.trans.insert_0
                  (+ main@%_1_0 (* 0 7) (* main@%_41_0 1))))))
(let ((a!2 (and (main@.lr.ph11 main@%.01.i.i_0
                               main@%_1_0
                               main@%sm6_0
                               main@%_24_0
                               main@%.02.i1.i110_2
                ...
                true
                true
                (= main@%_41_0 (+ main@%.02.i1.i110_0 1))
                (= main@%_42_0 (< main@%.02.i1.i110_0 main@%_26_0))
                (=> main@..lr.ph_crit_edge_0
                    (and main@..lr.ph_crit_edge_0 main@.lr.ph11_0))
                (=> (and main@..lr.ph_crit_edge_0 main@.lr.ph11_0) main@%_42_0)
                a!1
                (=> main@..lr.ph_crit_edge_0
                ...
                (=> main@..lr.ph_crit_edge_0
                    (= main@%_43_0 (= main@%.pre_0 main@%_24_0)))
                (=> main@.lr.ph11_1
                    (and main@.lr.ph11_1 main@..lr.ph_crit_edge_0))
                (=> (and main@.lr.ph11_1 main@..lr.ph_crit_edge_0)
                    (not main@%_43_0))
                (=> (and main@.lr.ph11_1 main@..lr.ph_crit_edge_0)
                    (= main@%.02.i1.i110_1 main@%_41_0))
                (=> (and main@.lr.ph11_1 main@..lr.ph_crit_edge_0)
                    (= main@%.02.i1.i110_2 main@%.02.i1.i110_1))
                main@.lr.ph11_1)))
  (=> a!2
      (main@.lr.ph11 main@%.01.i.i_0
                     main@%_1_0
                     main@%sm6_0
                     main@%_24_0
                     main@%.02.i1.i110_0
...
(let ((a!2 (and main@AllRepair_correct_FindC.exit.i.split
                ...
                (=> |tuple(main@..lr.ph_crit_edge_0, main@AllRepair_correct_FindC.exit.i_0)|
                    main@..lr.ph_crit_edge_0)
                (=> |tuple(main@.lr.ph11_0, main@AllRepair_correct_FindC.exit.i_0)|
                    main@.lr.ph11_0)
                (=> main@AllRepair_correct_FindC.exit.i_0
...
(rule (=> (and (main@.lr.ph5.preheader!_Cond
         ...
         true
         (=> (and main@.lr.ph_0 main@.lr.ph5.preheader_0) (= main@%_33_0 1))
         (=> (and main@.lr.ph_0 main@.lr.ph5.preheader_0)
             (= main@%_33_1 main@%_33_0))
         main@.lr.ph_0
         true
         (= main@%_30_0 @find_condition_0)
         (= main@%_32_0 (= main@%_31_0 0))
...
(rule (=> (and (main@.lr.ph5!_Cond
         ...
         (= main@%_38_0 (+ main@%_33_0 1))
         (=> main@.lr.ph_0 (and main@.lr.ph_0 main@.lr.ph5_0))
         true
         (=> (and main@.lr.ph_0 main@.lr.ph5_0) (= main@%_33_1 main@%_38_0))
         (=> (and main@.lr.ph_0 main@.lr.ph5_0) (= main@%_33_2 main@%_33_1))
         main@.lr.ph_0
         true
         (= main@%_35_0 @find_condition_0)
         (= main@%_37_0 (= main@%_36_0 main@%loop.bound_0))
