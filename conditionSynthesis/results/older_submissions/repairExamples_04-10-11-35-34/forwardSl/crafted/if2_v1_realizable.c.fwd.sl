...
(synth-fun mainventry!_Then ((x0 Int) (x1 Int) (x2 Int) (x3 Int) (x4 Int) (x5 Int) ) Bool)
(synth-fun mainventry!_Else ((x0 Int) (x1 Int) (x2 Int) (x3 Int) (x4 Int) (x5 Int) ) Bool)
(synth-fun mainventry!_BAD () Bool)
(synth-fun mainventry!_Cond ((x0 Int) (x1 Int) (x2 Int) (x3 Int) (x4 Int) (x5 Int) ) Bool)
