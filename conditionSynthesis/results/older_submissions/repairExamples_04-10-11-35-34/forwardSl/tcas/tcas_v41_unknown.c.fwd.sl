...
(let ((a!6 (and (mainventry vg_0 vfind_condition_0 mainv%sm46_0 vnd_0)
                ...
                (= mainv%sm5_0 (store mainv%sm55_0 mainv%Cur_Vertical_Sep_0 0))
                ...
                (= mainv%sm8_0 (store mainv%sm51_0 mainv%High_Confidence_0 0))
...
(constraint (=> (and (mainv_69!_FwdCond
           mainv%sm31_0
           mainv%Alt_Layer_Value_0
           vPositive_RA_Alt_Thresh_0
           mainv%sm35_0
    ...
    (mainv.critedge mainv%sm31_0
                    ...
                    mainv%Down_Separation_0
                    vg_0)))
(constraint (=> (and (not (mainv_69!_FwdCond
                mainv%sm31_0
                mainv%Alt_Layer_Value_0
                vPositive_RA_Alt_Thresh_0
                mainv%sm35_0
