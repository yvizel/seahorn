...
(synth-fun mainv_9!_FwdCond ((x0 Int) (x1 Int) (x2 Int) ) Bool)
...
(constraint (=> (and (mainv_9!_FwdCond vg_0 mainv%.0.i_0 vfind_condition_0)
...
(constraint (=> (and (not (mainv_9!_FwdCond vg_0 mainv%.0.i_0 vfind_condition_0))
         (mainv_9 vg_0 mainv%.0.i_0 vfind_condition_0)
         true
         (= mainv%_10_0 vfind_condition_0)
