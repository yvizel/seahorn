...
(synth-fun mainv_10!_FwdCond ((x0 Int) (x1 Int) (x2 Int) ) Bool)
...
(constraint (=> (and (not (mainventry!_FwdCond vg_0 vfind_condition_0 vnd_0))
         ...
         mainv_10_0)
    (mainv_10 vg_0 mainv%.0.i_1 vfind_condition_0)))
(constraint (=> (and (mainv_10!_FwdCond vg_0 mainv%.0.i_0 vfind_condition_0)
...
(constraint (=> (and (not (mainv_10!_FwdCond vg_0 mainv%.0.i_0 vfind_condition_0))
         (mainv_10 vg_0 mainv%.0.i_0 vfind_condition_0)
         true
         (= mainv%_11_0 vfind_condition_0)
