...
(synth-fun mainv.lr.ph5.preheader!_FwdCond ((x0 Int) (x1 (Array Int Int)) (x2 Int) (x3 Int) (x4 Int) (x5 Int) (x6 Int) ) Bool)
(synth-fun mainv.lr.ph5!_FwdCond ((x0 Int) (x1 (Array Int Int)) (x2 Int) (x3 Int) (x4 Int) (x5 Int) (x6 Int) (x7 Int) ) Bool)
...
(constraint (=> (and (mainv.lr.ph5.preheader!_FwdCond
           mainv%_1_0
           mainv%sm6_0
           mainv%_24_0
           mainv%_26_0
    ...
    (mainv.lr.ph mainv%_1_0
                 ...
                 mainv%loop.bound_0
                 mainv%_33_1)))
(constraint (=> (and (not (mainv.lr.ph5.preheader!_FwdCond
                mainv%_1_0
                mainv%sm6_0
                mainv%_24_0
                mainv%_26_0
    ...
    (mainvFindC.exit.i
      ...
      mainv%_26_0
      mainv%_4_0)))
(constraint (=> (and (mainv.lr.ph5!_FwdCond
           mainv%_1_0
           mainv%sm6_0
           mainv%_24_0
           mainv%_26_0
    ...
    (mainv.lr.ph mainv%_1_0
                 ...
                 mainv%loop.bound_0
                 mainv%_33_2)))
(constraint (=> (and (not (mainv.lr.ph5!_FwdCond
                mainv%_1_0
                mainv%sm6_0
                mainv%_24_0
                mainv%_26_0
