...
(let ((a!6 (and (mainventry vg_0 vfind_condition_0 mainv%sm46_0 vnd_0)
                ...
                (= mainv%sm10_0 (store mainv%sm48_0 mainv%Other_Capability_0 0))
                (> mainv%Two_of_Three_Reports_Valid_0 0)
                (= mainv%sm11_0
                   (store mainv%sm51_0 mainv%Two_of_Three_Reports_Valid_0 0))
                (> mainv%Other_RAC_0 0)
                (= mainv%sm12_0 (store mainv%sm47_0 mainv%Other_RAC_0 0))
...
(let ((a!17 (and (mainventry vg_0 vfind_condition_0 mainv%sm46_0 vnd_0)
                 ...
                 (> mainv%Other_Tracked_Alt_0 0)
                 (= mainv%sm7_0
                    (store mainv%sm57_0 mainv%Other_Tracked_Alt_0 0))
                 (> mainv%High_Confidence_0 0)
                 (= mainv%sm8_0 (store mainv%sm55_0 mainv%High_Confidence_0 0))
                 (> mainv%Own_Tracked_Alt_Rate_0 0)
                 (= mainv%sm9_0
                 ...
                 (> mainv%Other_Capability_0 0)
                 (= mainv%sm10_0
                    (store mainv%sm48_0 mainv%Other_Capability_0 0))
                 (> mainv%Two_of_Three_Reports_Valid_0 0)
                 (= mainv%sm11_0
                    (store mainv%sm51_0 mainv%Two_of_Three_Reports_Valid_0 0))
                 (> mainv%Other_RAC_0 0)
