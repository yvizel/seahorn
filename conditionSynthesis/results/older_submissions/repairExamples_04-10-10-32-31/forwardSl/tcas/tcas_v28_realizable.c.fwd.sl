...
(let ((a!6 (and (mainventry vg_0 vfind_condition_0 mainv%sm49_0 vnd_0)
                true
                ...
                (= mainv%sm3_0 (store mainv%sm45_0 mainv%Down_Separation_0 0))
                ...
                (= mainv%sm7_0 (store mainv%sm50_0 mainv%High_Confidence_0 0))
...
(let ((a!17 (and (mainventry vg_0 vfind_condition_0 mainv%sm49_0 vnd_0)
                 true
                 (= mainv%sm_0 mainv%sm49_0)
                 (> mainv%Alt_Layer_Value_0 0)
                 (= mainv%sm1_0 (store mainv%sm52_0 mainv%Alt_Layer_Value_0 0))
