...
(constraint (=> (and true
         ...
         (=> (and mainventry.split_0 mainventry_0) (not mainv%_13_0))
         mainventry.split_0)
...
(constraint (=> (and (mainventry.split!_Cond
         ...
         (=> (and mainventry.split_1 mainventry.split_0) mainv%_22_0)
         mainventry.split_1)
    (mainventry.split v__VERIFIER_nondet_int_0
                      vfind_condition_0
                      mainv%loop.bound_0)))
(constraint (=> (and (not (mainventry.split!_Cond
         ...
         (=> (and mainvverifier.error_0 mainventry.split_0) (not mainv%_22_0))
         mainvverifier.error_0
         true
...
(constraint (=> (and true
         ...
         (=> (and mainventry.split.us_0 mainventry_0) mainv%_13_0)
...
(constraint (=> (and (mainventry.split.us v__VERIFIER_nondet_int_0)
         true
         (= mainv%_14_0 v__VERIFIER_nondet_int_0)
