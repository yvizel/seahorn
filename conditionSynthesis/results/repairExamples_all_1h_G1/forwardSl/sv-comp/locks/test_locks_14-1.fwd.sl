...
(constraint (=> (and (mainventry v__VERIFIER_nondet_int_0 vfind_condition_0)
         ...
         (= mainv%_29_0 (= mainv%_24_0 0))
         (=> mainventry.split_0 (and mainventry.split_0 mainventry_0))
         (=> (and mainventry.split_0 mainventry_0) (not mainv%_29_0))
         mainventry.split_0)
...
(constraint (=> (and (mainventry v__VERIFIER_nondet_int_0 vfind_condition_0)
         ...
         (=> (and mainventry.split.us_0 mainventry_0) mainv%_29_0)
...
(constraint (=> (and (mainventry.split!_Cond
         ...
         (mainventry.split v__VERIFIER_nondet_int_0
                           ...
                           mainv%loop.bound_0)
         true
         (= mainv%_33_0 v__VERIFIER_nondet_int_0)
         (= mainv%_35_0 (= mainv%_34_0 0))
         (not mainv%_35_0)
         (= mainv%_36_0 vfind_condition_0)
         (= mainv%_38_0 (= mainv%_37_0 mainv%loop.bound_0))
         (=> mainventry.split_1 (and mainventry.split_1 mainventry.split_0))
         (=> (and mainventry.split_1 mainventry.split_0) mainv%_38_0)
         mainventry.split_1)
    (mainventry.split v__VERIFIER_nondet_int_0
                      vfind_condition_0
                      mainv%loop.bound_0)))
(constraint (=> (and (not (mainventry.split!_Cond
         ...
         (=> (and mainvverifier.error_0 mainventry.split_0) (not mainv%_38_0))
         mainvverifier.error_0)
    mainvverifier.error))
