...
(let ((a!6 (and (mainventry vg_0 vfind_condition_0 mainv%sm45_0 vnd_0)
                ...
                (= mainv%sm2_0 (store mainv%sm57_0 mainv%Up_Separation_0 0))
                (> mainv%Down_Separation_0 0)
                (= mainv%sm3_0 (store mainv%sm52_0 mainv%Down_Separation_0 0))
                (> mainv%Cur_Vertical_Sep_0 0)
                (= mainv%sm4_0 (store mainv%sm48_0 mainv%Cur_Vertical_Sep_0 0))
                (> mainv%Own_Tracked_Alt_0 0)
                (= mainv%sm5_0 (store mainv%sm55_0 mainv%Own_Tracked_Alt_0 0))
                (> mainv%Other_Tracked_Alt_0 0)
                (= mainv%sm6_0 (store mainv%sm56_0 mainv%Other_Tracked_Alt_0 0))
                (> mainv%High_Confidence_0 0)
                (= mainv%sm7_0 (store mainv%sm53_0 mainv%High_Confidence_0 0))
                (> mainv%Own_Tracked_Alt_Rate_0 0)
                (= mainv%sm8_0
                   (store mainv%sm51_0 mainv%Own_Tracked_Alt_Rate_0 0))
                (> mainv%Other_Capability_0 0)
                (= mainv%sm9_0 (store mainv%sm49_0 mainv%Other_Capability_0 0))
                (> mainv%Two_of_Three_Reports_Valid_0 0)
                (= mainv%sm10_0
                   (store mainv%sm54_0 mainv%Two_of_Three_Reports_Valid_0 0))
                (> mainv%Other_RAC_0 0)
                (= mainv%sm11_0 (store mainv%sm47_0 mainv%Other_RAC_0 0))
                (> mainv%Climb_Inhibit_0 0)
                (= mainv%sm12_0 (store mainv%sm50_0 mainv%Climb_Inhibit_0 0))
