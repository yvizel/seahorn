...
(let ((a!6 (and (mainventry vg_0 vfind_condition_0 mainv%sm45_0 vnd_0)
                ...
                (= mainv%sm2_0 (store mainv%sm54_0 mainv%Up_Separation_0 0))
                ...
                (= mainv%sm5_0 (store mainv%sm51_0 mainv%Own_Tracked_Alt_0 0))
                ...
                (= mainv%sm9_0 (store mainv%sm47_0 mainv%Other_Capability_0 0))
