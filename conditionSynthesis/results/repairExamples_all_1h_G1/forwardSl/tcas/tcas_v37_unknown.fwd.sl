...
(let ((a!6 (and (mainventry vg_0 vfind_condition_0 mainv%sm46_0 vnd_0)
                ...
                (= mainv%sm1_0 (store mainv%sm45_0 mainv%Up_Separation_0 0))
                (> mainv%Down_Separation_0 0)
                (= mainv%sm2_0 (store mainv%sm50_0 mainv%Down_Separation_0 0))
                (> mainv%Cur_Vertical_Sep_0 0)
                (= mainv%sm3_0 (store mainv%sm54_0 mainv%Cur_Vertical_Sep_0 0))
                (> mainv%Own_Tracked_Alt_0 0)
                (= mainv%sm4_0 (store mainv%sm52_0 mainv%Own_Tracked_Alt_0 0))
                ...
                (= mainv%sm11_0 (store mainv%sm51_0 mainv%Alt_Layer_Value_0 0))
