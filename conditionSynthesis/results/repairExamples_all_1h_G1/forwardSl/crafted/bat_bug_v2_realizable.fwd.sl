...
(synth-fun mainv_8 ((x0 Int) (x1 Int) (x2 Int) ) Bool
)
...
(constraint (let ((a!1 (and (mainv_8 vg_0 mainv%_3_0 mainv%_1_0)
                true
                ...
                mainvverifier.error_0)))
  (=> a!1 (mainvverifier.error mainv%.1.i_2))))
...
(constraint (=> (and (mainventry!_Cond vg_0 mainv%_1_0 mainv%_3_0 mainv%.1.i_1)
         ...
         mainv_8_0)
    (mainv_8 vg_0 mainv%_3_0 mainv%_1_0)))
