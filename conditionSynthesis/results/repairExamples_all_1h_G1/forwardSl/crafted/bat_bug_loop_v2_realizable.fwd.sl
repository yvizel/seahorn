...
(synth-fun mainv_11 ((x0 Int) (x1 Int) (x2 Int) (x3 Int) ) Bool
)
...
(constraint (=> (and (mainv_9 vg_0 mainv%loop.bound_0 mainv%_2_0 mainv%_4_0)
         true
         ...
         mainv_11_0)
    (mainv_11 vg_0 mainv%loop.bound_0 mainv%_2_0 mainv%.0.i_1)))
(constraint (=> (and (mainv_11 vg_0 mainv%loop.bound_0 mainv%_2_0 mainv%.0.i_0)
         true
...
(constraint (let ((a!1 (and (mainv_11 vg_0 mainv%loop.bound_0 mainv%_2_0 mainv%.0.i_0)
                true
                (= mainv%_12_0 (> mainv%_2_0 0))
...
(constraint (=> (and (mainventry!_Cond vg_0
         ...
         mainv_9_0)
    (mainv_9 vg_0 mainv%loop.bound_0 mainv%_2_0 mainv%_4_0)))
