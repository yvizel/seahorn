...
(synth-fun mainv.lr.ph5.preheader ((x0 Int) (x1 (Array Int Int)) (x2 Int) (x3 Int) (x4 Int) (x5 Bool) (x6 Int) (x7 Int) ) Bool
)
(synth-fun mainv.lr.ph ((x0 Int) (x1 (Array Int Int)) (x2 Int) (x3 Int) (x4 Int) (x5 Bool) (x6 Int) (x7 Int) (x8 Int) ) Bool
)
(synth-fun mainv.lr.ph5 ((x0 Int) (x1 (Array Int Int)) (x2 Int) (x3 Int) (x4 Int) (x5 Bool) (x6 Int) (x7 Int) (x8 Int) ) Bool
)
(synth-fun mainvFindC.exit.i ((x0 Int) (x1 (Array Int Int)) (x2 Int) (x3 Int) (x4 Int) (x5 Int) (x6 Bool) ) Bool
)
(synth-fun mainv.lr.ph13 ((x0 Int) (x1 (Array Int Int)) (x2 Int) (x3 Int) (x4 Int) (x5 Int) ) Bool
)
(synth-fun mainvAllRepair_correct_FindC.exit.i.split () Bool
)
(synth-fun mainventry!_BAD () Bool
)
(synth-fun mainv.lr.ph5.preheader!_Cond ((x0 Int) (x1 Int) (x2 Int) (x3 Int) (x4 (Array Int Int)) (x5 Int) (x6 Int) (x7 Bool) (x8 Int) (x9 Int) ) Bool
...
(synth-fun mainv.lr.ph5!_Cond ((x0 Int) (x1 Int) (x2 Int) (x3 Int) (x4 (Array Int Int)) (x5 Int) (x6 Int) (x7 Bool) (x8 Int) (x9 Int) ) Bool
    ((Start Bool) (Atom Bool) (Expr Int) (Arr (Array Int Int)))
    ((Start Bool (Atom (Variable Bool) (Constant Bool) ))
    (Atom Bool ((>= Expr Expr) (<= Expr Expr) (> Expr Expr) (< Expr Expr) (= Expr Expr) (distinct Expr Expr) ))
    (Expr Int ((Variable Int) (Constant Int) (select Arr Expr) ))
...
(declare-var mainv%.02.i1.i112_2 Int )
...
(declare-var mainvFindC.exit.i.thread_0 Bool )
(declare-var mainvAllRepair_correct_FindC.exit.i_0 Bool )
(declare-var mainv%.01.i.i11_0 Int )
(declare-var mainv%.01.i2.i_0 Int )
(declare-var mainv%.01.i.i11_1 Int )
...
(declare-var mainv%.02.i.i415_0 Int )
...
(declare-var mainv%.02.i1.i112_0 Int )
(declare-var mainv%.02.i1.i112_1 Int )
...
(constraint (let ((a!1 (= mainv%_2_0 (+ (+ mainv%_1_0 (* 0 7)) (* 0 1))))
  ...
  (=> (and (mainventry vfind_condition_0 vnd_char_0 vnd_int_0)
           ...
           (=> (and mainv.lr.ph5.preheader_0 mainventry_0) (not mainv%_29_0))
           mainv.lr.ph5.preheader_0)
...
(constraint (let ((a!1 (= mainv%_2_0 (+ (+ mainv%_1_0 (* 0 7)) (* 0 1))))
      ...
      (a!6 (= mainv%_19_0 (+ (+ mainv%_1_0 (* 0 7)) (* 5 1))))
      (a!7 (= mainv%_22_0 (+ (+ mainv%_1_0 (* 0 7)) (* 6 1)))))
(let ((a!8 (and (mainventry vfind_condition_0 vnd_char_0 vnd_int_0)
                true
                (= mainv%_0_0 (= mainv%loop.bound_0 0))
                mainv%_0_0
                (> mainv%_1_0 0)
                ...
                mainv%_28_0
                (= mainv%_29_0 (< mainv%_26_0 0))
                (=> mainvFindC.exit.i.thread_0
                    (and mainvFindC.exit.i.thread_0 mainventry_0))
                (=> (and mainvFindC.exit.i.thread_0 mainventry_0) mainv%_29_0)
                (=> mainvAllRepair_correct_FindC.exit.i_0
                    (and mainvAllRepair_correct_FindC.exit.i_0
                         mainvFindC.exit.i.thread_0))
                (=> (and mainvAllRepair_correct_FindC.exit.i_0
                         mainvFindC.exit.i.thread_0)
                    (= mainv%.01.i.i11_0 0))
                ...
                (=> (and mainvAllRepair_correct_FindC.exit.i_0
                         mainvFindC.exit.i.thread_0)
                    (= mainv%.01.i.i11_1 mainv%.01.i.i11_0))
                (=> (and mainvAllRepair_correct_FindC.exit.i_0
                         mainvFindC.exit.i.thread_0)
                    (= mainv%.01.i2.i_1 mainv%.01.i2.i_0))
                (=> mainvAllRepair_correct_FindC.exit.i_0
                    (= mainv%_42_0 (= mainv%.01.i.i11_1 mainv%.01.i2.i_1)))
                (=> mainvAllRepair_correct_FindC.exit.i_0 (not mainv%_42_0))
                (=> mainvAllRepair_correct_FindC.exit.i.split_0
                    (and mainvAllRepair_correct_FindC.exit.i.split_0
                         mainvAllRepair_correct_FindC.exit.i_0))
                mainvAllRepair_correct_FindC.exit.i.split_0)))
  (=> a!8 mainvAllRepair_correct_FindC.exit.i.split))))
(constraint (=> (and (mainv.lr.ph mainv%_1_0
                      ...
                      mainv%loop.bound_0)
         true
         (= mainv%_33_0 (< mainv%.02.i.i415_0 mainv%_26_0))
         (=> mainv.lr.ph5_0 (and mainv.lr.ph5_0 mainv.lr.ph_0))
         (=> (and mainv.lr.ph5_0 mainv.lr.ph_0) mainv%_33_0)
         mainv.lr.ph5_0)
...
(constraint (=> (and (mainv.lr.ph mainv%_1_0
         ...
         (=> (and mainvFindC.exit.i_0 mainv.lr.ph_0) (not mainv%_33_0))
...
(constraint (let ((a!1 (and (mainvFindC.exit.i
                ...
                (=> (and mainv.lr.ph.preheader_0 mainvFindC.exit.i_0)
                    (not mainv%_29_0))
                (=> mainv.lr.ph.preheader_0
                    (= mainv%_38_0 (= mainv%_4_0 mainv%_24_0)))
                (=> mainv.lr.ph13_0
                    (and mainv.lr.ph13_0 mainv.lr.ph.preheader_0))
                (=> (and mainv.lr.ph13_0 mainv.lr.ph.preheader_0)
                    (not mainv%_38_0))
                (=> (and mainv.lr.ph13_0 mainv.lr.ph.preheader_0)
                    (= mainv%.02.i1.i112_0 0))
                (=> (and mainv.lr.ph13_0 mainv.lr.ph.preheader_0)
                    (= mainv%.02.i1.i112_1 mainv%.02.i1.i112_0))
                mainv.lr.ph13_0)))
  (=> a!1
      (mainv.lr.ph13 mainv%_1_0
                     mainv%sm6_0
                     mainv%_24_0
                     mainv%.01.i.i_0
                     mainv%.02.i1.i112_1
...
(constraint (let ((a!1 (and (mainvFindC.exit.i
                ...
                (=> |tuple(mainvFindC.exit.i_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    mainv%_29_0)
                (=> |tuple(mainv.lr.ph.preheader_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    (= mainv%.01.i.i11_0 mainv%.01.i.i_0))
                (=> |tuple(mainv.lr.ph.preheader_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    (= mainv%.01.i2.i_0 1))
                (=> |tuple(mainvFindC.exit.i_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    (= mainv%.01.i.i11_1 mainv%.01.i.i_0))
                (=> |tuple(mainvFindC.exit.i_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    (= mainv%.01.i2.i_1 0))
                (=> |tuple(mainv.lr.ph.preheader_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    (= mainv%.01.i.i11_2 mainv%.01.i.i11_0))
                (=> |tuple(mainv.lr.ph.preheader_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    (= mainv%.01.i2.i_2 mainv%.01.i2.i_0))
                (=> |tuple(mainvFindC.exit.i_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    (= mainv%.01.i.i11_2 mainv%.01.i.i11_1))
                (=> |tuple(mainvFindC.exit.i_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    (= mainv%.01.i2.i_2 mainv%.01.i2.i_1))
                (=> mainvAllRepair_correct_FindC.exit.i_0
                    (= mainv%_42_0 (= mainv%.01.i.i11_2 mainv%.01.i2.i_2)))
                (=> mainvAllRepair_correct_FindC.exit.i_0 (not mainv%_42_0))
                (=> mainvAllRepair_correct_FindC.exit.i.split_0
                    (and mainvAllRepair_correct_FindC.exit.i.split_0
                         mainvAllRepair_correct_FindC.exit.i_0))
...
(constraint (let ((a!1 (=> mainv..lr.ph_crit_edge_0
               (= mainv%.phi.trans.insert_0
                  (+ mainv%_1_0 (* 0 7) (* mainv%_39_0 1))))))
(let ((a!2 (and (mainv.lr.ph13 mainv%_1_0
                               mainv%sm6_0
                               mainv%_24_0
                               mainv%.01.i.i_0
                               mainv%.02.i1.i112_0
                               mainv%_26_0)
                true
                (= mainv%_39_0 (+ mainv%.02.i1.i112_0 1))
                (= mainv%_40_0 (< mainv%.02.i1.i112_0 mainv%_26_0))
                (=> mainv..lr.ph_crit_edge_0
                    (and mainv..lr.ph_crit_edge_0 mainv.lr.ph13_0))
                (=> (and mainv..lr.ph_crit_edge_0 mainv.lr.ph13_0) mainv%_40_0)
                a!1
                (=> mainv..lr.ph_crit_edge_0
                ...
                (=> mainv..lr.ph_crit_edge_0
                    (= mainv%_41_0 (= mainv%.pre_0 mainv%_24_0)))
                (=> mainv.lr.ph13_1
                    (and mainv.lr.ph13_1 mainv..lr.ph_crit_edge_0))
                (=> (and mainv.lr.ph13_1 mainv..lr.ph_crit_edge_0)
                    (not mainv%_41_0))
                (=> (and mainv.lr.ph13_1 mainv..lr.ph_crit_edge_0)
                    (= mainv%.02.i1.i112_1 mainv%_39_0))
                (=> (and mainv.lr.ph13_1 mainv..lr.ph_crit_edge_0)
                    (= mainv%.02.i1.i112_2 mainv%.02.i1.i112_1))
                mainv.lr.ph13_1)))
  (=> a!2
      (mainv.lr.ph13 mainv%_1_0
                     mainv%sm6_0
...
(let ((a!2 (and (mainv.lr.ph13 mainv%_1_0
                ...
                (=> |tuple(mainv..lr.ph_crit_edge_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    mainv..lr.ph_crit_edge_0)
                (=> |tuple(mainv.lr.ph13_0, mainvAllRepair_correct_FindC.exit.i_0)|
                    mainv.lr.ph13_0)
                (=> mainvAllRepair_correct_FindC.exit.i_0
...
(constraint (=> (and (mainv.lr.ph5.preheader!_Cond
         ...
         (=> (and mainv.lr.ph_0 mainv.lr.ph5.preheader_0)
             (= mainv%.02.i.i415_0 0))
         (=> (and mainv.lr.ph_0 mainv.lr.ph5.preheader_0)
             (= mainv%.02.i.i415_1 mainv%.02.i.i415_0))
         mainv.lr.ph_0)
...
(constraint (=> (and (mainv.lr.ph5!_Cond
         ...
         (mainv.lr.ph5 mainv%_1_0
                       ...
                       mainv%loop.bound_0)
         true
         (= mainv%_34_0 (+ mainv%.02.i.i415_0 1))
         ...
         (=> (and mainv.lr.ph_0 mainv.lr.ph5_0)
             (= mainv%.02.i.i415_1 mainv%_34_0))
         (=> (and mainv.lr.ph_0 mainv.lr.ph5_0)
             (= mainv%.02.i.i415_2 mainv%.02.i.i415_1))
         mainv.lr.ph_0)
    (mainv.lr.ph mainv%_1_0
                 mainv%sm6_0
                 mainv%_24_0
