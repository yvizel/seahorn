...
(let ((a!5 (or (<= (select mainv%sm26_0 mainv%High_Confidence_0) 0)
               ...
               (not (<= (select mainv%sm29_0 mainv%Own_Tracked_Alt_Rate_0) 600))
               (not (>= (select mainv%sm25_0 mainv%Cur_Vertical_Sep_0) 601))))
      (a!7 (or (not (= (select mainv%sm36_0 mainv%Climb_Inhibit_0) 0))
               (not a!2)
               a!6)))
  (and a!5 a!7)))
)
...
(let ((a!4 (or (not (<= (select mainv%sm35_0 mainv%Other_Capability_0) 0))
      ...
      (a!6 (or (not (<= (select mainv%sm35_0 mainv%Other_Capability_0) 0))
               ...
               (not (<= (select mainv%sm29_0 mainv%Own_Tracked_Alt_Rate_0) 600))
               (not (>= (select mainv%sm25_0 mainv%Cur_Vertical_Sep_0) 601))))
      (a!7 (or (not (= (select mainv%sm34_0 mainv%Other_RAC_0) 0))
               (<= (select mainv%sm27_0 mainv%Two_of_Three_Reports_Valid_0) 0)
               (not (= (select mainv%sm40_0 vPositive_RA_Alt_Thresh_0) 400))
               (<= (select mainv%sm26_0 mainv%High_Confidence_0) 0)
               a!1
...
(let ((a!12 (or (not (= mainv%_92_0 0))
  ...
  (and a!5
       ...
       a!24
       a!25
       (or (not (= mainv%_92_0 0)) (not a!13) a!22)
       a!26
       a!27))))
)
...
(let ((a!12 (or (not (= mainv%_92_0 0))
  ...
  (and a!5
       ...
       a!23
       a!24
       (or (not (= mainv%_92_0 0)) (not a!13) a!21)
       a!25))))
)
