...
(let ((a!8 (or a!3
      ...
      (a!18 (or (not (<= (select main@%sm35_0 main@%Other_Capability_0) 0))
                ...
                (<= main@%_92_0 0)
                (<= (select main@%sm36_0 main@%Climb_Inhibit_0) 0)))
      (a!22 (not (>= (+ (select main@%sm33_0 main@%Down_Separation_0)
                        (* (- 1) a!12))
                     0)))
      (a!25 (or (not (<= (select main@%sm35_0 main@%Other_Capability_0) 0))
                (<= (select main@%sm26_0 main@%High_Confidence_0) 0)
                (not (>= (select main@%sm25_0 main@%Cur_Vertical_Sep_0) 601))
                a!9
                a!10
      ...
      (a!26 (or (not (= (select main@%sm34_0 main@%Other_RAC_0) 0))
                ...
                (<= main@%_92_0 0)
                (<= (select main@%sm36_0 main@%Climb_Inhibit_0) 0)))
      (a!27 (not (>= (+ (select main@%sm32_0 main@%Up_Separation_0)
                        (* (- 1) a!12))
                     0)))
      (a!29 (or (not (= (select main@%sm34_0 main@%Other_RAC_0) 0))
                a!3
                a!4
                (<= (select main@%sm27_0 main@%Two_of_Three_Reports_Valid_0) 0)
                (<= (select main@%sm26_0 main@%High_Confidence_0) 0)
                ...
                (not (<= (select main@%sm29_0 main@%Own_Tracked_Alt_Rate_0) 600))
                (not a!7)))
      (a!30 (or (not (= (select main@%sm34_0 main@%Other_RAC_0) 0))
                (<= (select main@%sm27_0 main@%Two_of_Three_Reports_Valid_0) 0)
                (<= (select main@%sm26_0 main@%High_Confidence_0) 0)
                (not (>= (select main@%sm25_0 main@%Cur_Vertical_Sep_0) 601))
                a!9
...
(let ((a!7 (or (not (= main@%_92_0 0))
      ...
      (a!27 (or (= main@%_92_0 0)
                ...
                (>= (+ (select main@%sm33_0 main@%Down_Separation_0)
                       (* (- 1) a!12))
                    0)))
      (a!28 (not (>= (+ (select main@%sm32_0 main@%Up_Separation_0)
                        (* (- 1) a!12))
                     0)))
      (a!30 (or (= main@%_92_0 0)
                (<= (select main@%sm27_0 main@%Two_of_Three_Reports_Valid_0) 0)
                (not (= (select main@%sm34_0 main@%Other_RAC_0) 0))
                (<= (select main@%sm26_0 main@%High_Confidence_0) 0)
                (not (>= (select main@%sm25_0 main@%Cur_Vertical_Sep_0) 601))
...
(let ((a!25 (or (not (= main@%_92_0 0))
  ...
  (and (or (not (= main@%_92_0 0)) (not a!1) (not a!2))
       (or (not (= main@%_92_0 0))
           ...
           (not a!3)
           (not a!4))
       (or (not (= main@%_92_0 0)) (not a!5) a!6)
       a!7
