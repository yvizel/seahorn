...
(define-fun main@_9 ((@g_0 Int) (main@%loop.bound_0 Int) (main@%_2_0 Int) (main@%_4_0 Int) ) Bool
	true
)
(define-fun main@_11 ((@g_0 Int) (main@%loop.bound_0 Int) (main@%_2_0 Int) (main@%.0.i_1 Int) ) Bool
	(or (not (>= main@%.0.i_1 9)) (not (>= main@%loop.bound_0 3)))
)
(define-fun psi_f_0 ((@g_0 Int) (main@%loop.bound_0 Int) (main@%_2_0 Int) (main@%_4_0 Int) (main@%.0.i_1 Int) ) Bool
(and (main@_11 @g_0 main@%loop.bound_0 main@%_2_0 main@%.0.i_1) (not (main@entry!_Cond @g_0 main@%loop.bound_0 main@%_2_0 main@%_4_0 main@%.0.i_1)))
)
(define-fun psi_t_0 ((@g_0 Int) (main@%loop.bound_0 Int) (main@%_2_0 Int) (main@%_4_0 Int) (main@%.0.i_1 Int) ) Bool
(or (main@entry!_Cond @g_0 main@%loop.bound_0 main@%_2_0 main@%_4_0 main@%.0.i_1) (not (main@_9 @g_0 main@%loop.bound_0 main@%_2_0 main@%_4_0)))
)
(declare-var @g_0 Int)
