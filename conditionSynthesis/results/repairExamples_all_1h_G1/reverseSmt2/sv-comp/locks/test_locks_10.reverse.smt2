...
(rule (=> (and (main@entry.split @__VERIFIER_nondet_int_0
         ...
         (= main@%_21_0 (= main@%_4_0 0))
         (=> main@entry.split_0 (and main@entry.split_0 main@entry_0))
         (=> (and main@entry.split_0 main@entry_0) (not main@%_21_0))
         main@entry.split_0)
...
(rule (=> (and (main@entry.split.us @__VERIFIER_nondet_int_0 @find_condition_0)
         ...
         (=> (and main@entry.split.us_0 main@entry_0) main@%_21_0)
...
(rule (=> (and (main@entry.split.us @__VERIFIER_nondet_int_0 @find_condition_0)
         true
         true
         (= main@%_22_0 @__VERIFIER_nondet_int_0)
         (= main@%_24_0 (= main@%_23_0 0))
         (not main@%_24_0)
         (= main@%_25_0 @find_condition_0)
...
(rule (=> (and (main@entry.split!_Cond
         ...
         (= main@%_32_0 (= main@%_31_0 main@%loop.bound_0))
