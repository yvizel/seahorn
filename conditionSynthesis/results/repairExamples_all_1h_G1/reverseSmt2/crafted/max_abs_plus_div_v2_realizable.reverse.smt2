...
(declare-rel main@_17 (Int Int Int ))
(declare-rel main@.lr.ph (Int Int Int ))
(declare-rel main@verifier.error.split ())
(declare-rel main@entry!_BAD ())
(declare-rel main@_10!_Cond (Int Int Int Int ))
...
(rule (=> (and (main@_10 main@%loop.bound_0 main@%_2_0 @g_0 @find_condition_0)
         true
         true
...
(rule (=> (and (main@.lr.ph main@%.1.i2_1 main@%.01.i1_1 main@%loop.bound_0)
         ...
         main@.lr.ph_0)
    (main@entry @g_0 @find_condition_0 @nd_0)))
(rule (=> (and (main@_17 main@%loop.bound_0 main@%_2_0 main@%.0.i_1)
         true
         true
         (= main@%_14_0 @g_0)
...
(rule (=> (and (main@.lr.ph main@%.1.i2_1 main@%.01.i1_1 main@%loop.bound_0)
         ...
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%.01.i1_1 main@%.01.i1_0))
         main@.lr.ph_0)
    (main@_17 main@%loop.bound_0 main@%_2_0 main@%.0.i_0)))
(rule (let ((a!1 (and main@verifier.error.split
                ...
                main@verifier.error.split_0)))
  (=> a!1 (main@_17 main@%loop.bound_0 main@%_2_0 main@%.0.i_0))))
...
(rule (=> (and (main@_10!_Cond @g_0 main@%loop.bound_0 main@%_2_0 main@%.0.i_1)
         true
...
(rule (=> (and (main@_13 main@%loop.bound_0 main@%_2_0 @g_0)
         (main@_17 main@%loop.bound_0 main@%_2_0 main@%.0.i_1))
    (main@_10!_Cond @g_0 main@%loop.bound_0 main@%_2_0 main@%.0.i_1)))
