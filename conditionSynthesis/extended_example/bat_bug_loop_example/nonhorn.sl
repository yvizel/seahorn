...
(synth-fun main@_9 ((x0 Int) (x1 Int) (x2 Int) (x3 Int) ) Bool)
...
(synth-fun main@entry!_Cond ((x0 Int) (x1 Int) (x2 Int) (x3 Int) (x4 Int) ) Bool)
(synth-fun main@entry!_FwdCond ((x0 Int) (x1 Int) (x2 Int) ) Bool)
...
(constraint (main@entry @g_0 @nd_0 @find_condition_0))
(constraint (=> (and (main@_9 main@%loop.bound_0 main@%_2_0 @g_0 main@%_4_0)
         true
         (= main@%_10_0 @g_0)
...
(constraint (=> (and (main@_13 main@%loop.bound_0 main@%_2_0 main@%.0.i_0)
         true
...
(constraint (let ((a!1 (and (main@_13 main@%loop.bound_0 main@%_2_0 main@%.0.i_0)
                true
                (= main@%_14_0 (> main@%_2_0 0))
...
(constraint (let ((a!1 (and (main@.lr.ph main@%.1.i2_0 main@%.01.i1_0 main@%loop.bound_0)
                ...
                main@verifier.error.split_0)))
  (=> a!1 main@verifier.error.split)))
(constraint (=> (and (main@entry!_FwdCond @g_0 @nd_0 @find_condition_0)
...
(constraint (=> (and (not (main@entry!_FwdCond @g_0 @nd_0 @find_condition_0))
         (main@entry @g_0 @nd_0 @find_condition_0)
         true
         (= main@%_0_0 (= main@%loop.bound_0 3))
         main@%_0_0
         ...
         (=> (and main@_13_0 main@entry_0) (not main@%_8_0))
